...
public class ArticuloBean extends Object {
    ...
    public ArticuloBean [] getArticulosSede(String url) throws SQLException,Exception{
        ...
        ArticuloBean [] articulos= servicio_articulos.getArticulosDisponibles();
    ...
    public void setEstado(String estado) throws Exception {
        ...
        try{
            ...
            // en el servidor central la consulta da error
        }
